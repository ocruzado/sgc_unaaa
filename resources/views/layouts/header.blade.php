                    ...
                    <div class="d-flex">
                        ...
                        <div class="navbar-brand-box">
                            <a href="{{ route('home') }}" class="logo logo-dark">
                                <span class="logo-sm">
                                    <!-- img src="{{ asset('img/sgc_unaaa.png') }}" alt="" height="10"> -->
                                </span>
                                <span class="logo-lg">
                                    <img src="{{ asset('img/sgc_unaaa.png') }}" alt="" height="20">
                                </span>
                            </a>
                    ...
                    <div class="d-flex">
                        ...
                        <div class="dropdown d-inline-block user-dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                <!-- item-->
                                <a class="dropdown-item" href="#"><i class="ri-user-line align-middle mr-1"></i> Mi perfil</a>
                                <!-- 
                                ...
                                <a class="dropdown-item text-danger" href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                                    <i class="ri-shut-down-line align-middle mr-1 text-danger"></i> Cerrar sesión
                                </a>
